...
#ifndef __INET_MICHA_IPV4_H
#define __INET_MICHA_IPV4_H
...
#include "inet/networklayer/ipv4/RL_Sarsa.h"
 ...
 */
class INET_API MichaIpv4 : public QueueBase, public NetfilterBase, public ILifecycle, public INetworkProtocol, public IProtocolRegistrationListener, public cListener
{
  public:
    /**
  ...
  protected:
    ...
    RL_Sarsa* sarsa;
    actions choosedAction;
    cOutVector *choosenActions;
    cOutVector *sentBytesVec;
    uint32_t ecn_threshold;
    bool regularRun;
    //cOutVector endToEndDelayVec;

    int sourceIdFilter {0};
    int dstAddrFilter {0};
    uint32_t QLength = 0;
    uint32_t packetDropped = 0;
    uint32_t packetDroppedAccumDbg = 0;
    uint64_t bytesSent = 0;
    uint32_t tcpConnCounter = 0;
    simtime_t queuingTimeAccum = 0;
    cMessage *rlStatTimerMsg;
    simtime_t timerDelta;
    simsignal_t queueLengthSignalId 	= 0;
    simsignal_t packetDequeuedSignalId 	= 0;
    simsignal_t queueingTimeSignalId 	= 0;
    simsignal_t packetDroppedSignalId 	= 0;
    simsignal_t packetEnqueuedSignalId 	= 0;
    simsignal_t tcpConnectionAddedSignalId  = 0;
    simsignal_t tcpConnectionRemovedSignalId  = 0;

    bool doMarkWithEcn = false;
  ...
  public:
    ...
    //void receiveSignal(cComponent *source, simsignal_t signalID, simtime_t value, cObject *details);
